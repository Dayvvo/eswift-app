...
router.route('/').post(isAuth, propertyController.createProperty).get(hasAuth, propertyController.getCreatedProperties);

router.route('/favourite/:propertyId').post(hasAuth, favouritePropertyController.addToFavourites);

router.get('/favourite', isAuth, favouritePropertyController.getAllFavouriteProperty);

router.delete('/favourite/:id', favouritePropertyController.removeFromFavouriteProperty);

router.get('/props', propertyController.getPropertyDocs);

router.get('/admin', propertyController.adminGetAllProperties);
router.get('/few-admin', propertyController.getFewAdminProperties);
router.get('/few-verified', propertyController.getFewVerifiedProperties);
router.get('/verified-properties', propertyController.getVerifiedProperties);
router.get('/verified-projects', propertyController.getVerifiedProjects);
